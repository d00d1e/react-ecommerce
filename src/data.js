const data = {
  products:[
    ...
    },
    {
      ...
      rating: 3.5,
      numReviews: 73,
      description: 'The ponytail palm (Beaucarnea recurvata) makes a surprisingly interesting desktop plant, considering that when grown outdoors it can be a full-size tree that towers over homes. Indoors, these novel little trees are often grown in shallow pots, with a tuft of strappy green leaves emerging from a bulbous stem that seems to erupt from the soil.'
    },
    {
      _id: '14',
    ...
    },
    {
      ...
      rating: 5,
      numReviews: 100,
      description: 'These are ideal orchids for beginners, since they tolerate clumsy repotting efforts, and bloom on and off throughout the year. These orchids prefer diffused lighting conditions but are otherwise very easy to grow. There are about 75 recognized species within the genus and many dozens of readily available cultivars. They will thrive in indirect indoor lighting or a shady outdoor location.'
    }
  ]
}
